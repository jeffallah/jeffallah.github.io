...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        ...
        <div class="ui large labeled input"><input type="text" value="xd" placeholder="Nickname" maxlength="14" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
...
inverted button"><i class="github icon"></i>Open Source Code</a><a href="https://gabimaruthehollow2.github.io/v2/" class="ui right floated
...
let scripturl = "https://github.com/gabimaruthehollow2/gabimaruthehollow2.github.io/raw/main/script/Gartic%20bot%20control.user.js";
...
iziToast.success({
	...
	buttons: [
        ['<button>Open Source Code</button>', function (instance, toast) {
            window.open("https://github.com/gabimaruthehollow2/gabimaruthehollow2.github.io");
        }, true],],
});
}else{
iziToast.error({
